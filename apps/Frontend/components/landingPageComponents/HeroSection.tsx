  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-28 md:pt-32 pb-10 sm:pb-16 px-2 sm:px-6 md:px-10 w-full overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl px-2 sm:px-0">
        <AnimatedBadge>
          <span className="text-md md:text-md md:text-xl md:text-2xl">✨</span> <span className="text-base xs:text-lg sm:text-xl">Real-time collaborative canvas</span>
        </AnimatedBadge>
        <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-zinc-900 dark:text-white drop-shadow-lg mb-3 sm:mb-4 animate-fade-in-up leading-tight">
          Draw together. Think visually.<br className="hidden sm:inline" /> Ship faster.
        </h1>
        <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl font-medium text-zinc-700 dark:text-zinc-200 max-w-xs sm:max-w-xl md:max-w-2xl mb-4 sm:mb-6 animate-fade-in-up delay-100 leading-snug">
